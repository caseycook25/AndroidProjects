...
public class DownloadImageTask extends AsyncTask<String, Void, Bitmap> {
    ...
    private int pos;
    private CustomAdapter.ViewHolder posHolder;

    public DownloadImageTask(String pictureID, ImageView imageView, int pos, CustomAdapter.ViewHolder posHolder) {
    ...
    protected void onPostExecute(Bitmap result) {
        ...
        if (result != null && pos == posHolder.position) {
